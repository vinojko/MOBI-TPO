...
{
    [SerializeField]
    private Color32 linkStartingColor = new Color32(0xFF, 0xFF, 0xFF, 0xFF); // White by default for links
    [SerializeField]
    ...
    private void SetLinkStartingColor()
    {
        TMP_TextInfo textInfo = textMeshPro.textInfo;
        foreach (var linkInfo in textInfo.linkInfo)
        {
            for (int i = 0; i < linkInfo.linkTextLength; i++)
            {
                ...
                vertexColors[vertexIndex + 0] = linkStartingColor;
                vertexColors[vertexIndex + 1] = linkStartingColor;
                vertexColors[vertexIndex + 2] = linkStartingColor;
                vertexColors[vertexIndex + 3] = linkStartingColor;
            }
        }
